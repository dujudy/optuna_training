...
python3 run_optuna_sklearn.py --model_name GB --lang_model_type {lang_type} --scoring_metric {metric} --feature_type {data_type} --pca_key {pca} --results_folder /tigress/jtdu/optuna_training/sklearn/results/ >> /tigress/jtdu/optuna_training/sklearn/sh/opt_{metric}{data_type}{lang_type}.log
