...
def objective(trial, train, test, type, feats, input_df, metric):
    ...
    params = {
        ...
        "min_samples_leaf": trial.suggest_int("min_samples_leaf", 1, 10),  make min larger 1--> 5?
        "random_state": 7
    }
...
if __name__ == "__main__":
    ...
    # Specification args
    parser.add_argument("--test_size", type=float, default=0.1, help="Percentage of data to use in hold-out test set.")

    args = parser.parse_args()
    main(args.feature_type, args.scoring_metric, n_trials = 200)
