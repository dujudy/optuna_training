...
class DataSpecification(args):
    def __init__(self, args):
        if args.lang_model_type == "Rostlab_Bert":
            ## Define path dict to training/testing data
            self.data_paths = {
                "training": args.training_path,
                "mcf10A": "/tigress/jtdu/map_language_models/user_files/mmc2_newlabs_key_Rostlab_Bert_reference.tsv",
                "maveDB": "/tigress/jtdu/map_language_models/user_files/mavedb_offset_key_Rostlab_Bert_reference.tsv"
            }
            if len(args.testing_path) > 0:
                for i in range(0, len(args.testing_path)):
                    data_paths[args.testing_alias[i]] = args.testing_path[i]
            ...
            self.pca_mats = {
             "pca100": "/tigress/jtdu/map_language_models/user_files/hs/pca1500aa/pcamatrix_Hg38samp_dim_100.pca",
             "pca250": "/tigress/jtdu/map_language_models/user_files/hs/pca1500aa/pcamatrix_Hg38samp_dim_250.pca",
             "pca500": "/tigress/jtdu/map_language_models/user_files/hs/pca1500aa/pcamatrix_Hg38samp_dim_500.pca",
             "pca1000": "/tigress/jtdu/map_language_models/user_files/hs/pca1500aa/pcamatrix_Hg38samp_dim_1000.pca"
            }
        ...
        self.exclude = {
            "training": [], "crossvalidation_1": []; "crossvalidation_2":[];
            "testing": [],
