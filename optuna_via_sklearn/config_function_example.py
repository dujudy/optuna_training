...
def configure(args):
    ...
    if args.lang_model_type == "Rostlab_Bert":
        ...
        ref_paths = {
        "crossvalidation_1": root + "crossvalidation_1_primateNegativesDocmPositives_key_Rostlab_Bert_reference.tsv",
        ...
        mut_paths = {
        "crossvalidation_1": root + 'crossvalidation_1_primateNegativesDocmPositives_key_Rostlab_Bert_mutant.tsv',
        ...
        start = {"crossvalidation_1":6, "d2":6, "t1":8, "t2":8, "mcf10A":15, "ptenDMS":10, "maveDB":13}
        ...
        ref_paths = {
            "crossvalidation_1": root + "crossvalidation_1_primateNegativesDocmPositives_key_UniRep_reference.tsv", #"crossvalidation_1_primateNegativesDocmPositives_reference.tsv",
        ...
        mut_paths = {
         "crossvalidation_1": root + 'crossvalidation_1_primateNegativesDocmPositives_key_UniRep_mutant.tsv',
        ...
        start = {"crossvalidation_1":5, "d2":5, "t1":8, "t2":8, "mcf10A":14, "ptenDMS":10, "maveDB":12 }
